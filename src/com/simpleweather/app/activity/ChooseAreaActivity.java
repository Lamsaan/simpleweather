		...
		HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
			...
			public void onFinish(String response) {
				...
				if("province".equals(type)){
					result=Utility.handlerProvinceResponse(simpleWeatherDB, response);
				}else if("city".equals(type)){
					result = Utility.handlerCitiesResponse(simpleWeatherDB, response, selectedProvince.getId());
				}else if("county".equals(type)){
					result = Utility.handlerCountiesResponse(simpleWeatherDB, response, selectedCity.getId());
				}
				if(result){
